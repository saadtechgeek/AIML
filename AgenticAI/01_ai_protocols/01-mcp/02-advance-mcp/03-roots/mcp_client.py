...
class MCPClient:
    ...
    # Instead, the server can make a request to the client at some future point in time.
    # We make a callback that will be executed when the server requests the roots. The callback 
    # needs to return the list of roots inside of a ListRootsResult object.
